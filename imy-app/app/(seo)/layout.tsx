...
.km-label{font-family:'Sometype Mono',ui-monospace,monospace;font-size:12px;letter-spacing:.16em;text-transform:uppercase;color:#8A5F43;margin:0 0 18px;}
...
.km-home a{color:#8A5F43;text-decoration:none;border-bottom:1px solid rgba(168,124,95,.4);}
`,
        }}
      />
