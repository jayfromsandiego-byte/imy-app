...
export const seoCatalog: SeoEntry[] = [
  ...
  { slug: "funeral-costs/california", section: "guides", cluster: "cost", h1: "Funeral Costs in California (2026)", description: "California funeral costs against the national median, with the state's own rules on embalming, home burial, and direct cremation.", status: "live" },
  { slug: "funeral-costs/texas", section: "guides", cluster: "cost", h1: "Funeral Costs in Texas (2026)", description: "Texas funeral costs and rules — medians, direct cremation, and what the state requires.", status: "live" },
  { slug: "funeral-costs/florida", section: "guides", cluster: "cost", h1: "Funeral Costs in Florida (2026)", description: "Florida funeral costs and rules, with the state's medians and legal notes.", status: "live" },
  { slug: "funeral-costs/new-york", section: "guides", cluster: "cost", h1: "Funeral Costs in New York (2026)", description: "New York funeral costs and rules, with the state's medians and legal notes.", status: "live" },
  { slug: "funeral-costs/pennsylvania", section: "guides", cluster: "cost", h1: "Funeral Costs in Pennsylvania (2026)", description: "Pennsylvania funeral costs and rules, with the state's medians and legal notes.", status: "live" },
  { slug: "funeral-costs/illinois", section: "guides", cluster: "cost", h1: "Funeral Costs in Illinois (2026)", description: "Illinois funeral costs and rules, with the state's medians and legal notes.", status: "live" },
  { slug: "funeral-costs/georgia", section: "guides", cluster: "cost", h1: "Funeral Costs in Georgia (2026)", description: "Georgia funeral costs and rules, with the state's medians and legal notes.", status: "live" },
  { slug: "funeral-costs/ohio", section: "guides", cluster: "cost", h1: "Funeral Costs in Ohio (2026)", description: "Ohio funeral costs and rules — regional medians, embalming law, home burial, and the Funeral Rule.", status: "live" },
  { slug: "funeral-costs/north-carolina", section: "guides", cluster: "cost", h1: "Funeral Costs in North Carolina (2026)", description: "North Carolina funeral costs and rules, with the region's medians and the state's own laws on embalming and water cremation.", status: "live" },
  { slug: "funeral-costs/michigan", section: "guides", cluster: "cost", h1: "Funeral Costs in Michigan (2026)", description: "Michigan funeral costs and rules — regional medians, the 48-hour embalming rule, and private burial grounds.", status: "live" },
  { slug: "funeral-costs/new-jersey", section: "guides", cluster: "cost", h1: "Funeral Costs in New Jersey (2026)", description: "New Jersey funeral costs and rules, with the region's medians and the state's own consumer protections for cremation.", status: "live" },
  { slug: "funeral-costs/virginia", section: "guides", cluster: "cost", h1: "Funeral Costs in Virginia (2026)", description: "Virginia funeral costs and rules, with the region's medians and the state's embalming-consent law.", status: "live" },
  { slug: "funeral-costs/washington", section: "guides", cluster: "cost", h1: "Funeral Costs in Washington (2026)", description: "Washington funeral costs and rules — regional medians, refrigeration in place of embalming, and water cremation.", status: "live" },
  { slug: "funeral-costs/arizona", section: "guides", cluster: "cost", h1: "Funeral Costs in Arizona (2026)", description: "Arizona funeral costs and rules, with the Mountain division's medians and the state's burial-permit paperwork.", status: "live" },
  { slug: "funeral-costs/tennessee", section: "guides", cluster: "cost", h1: "Funeral Costs in Tennessee (2026)", description: "Tennessee funeral costs and rules, with the region's medians and legal notes.", status: "live" },
  { slug: "funeral-costs/massachusetts", section: "guides", cluster: "cost", h1: "Funeral Costs in Massachusetts (2026)", description: "Massachusetts funeral costs — the country's most expensive region, itemized, with the state's own rules.", status: "live" },
  { slug: "funeral-costs/indiana", section: "guides", cluster: "cost", h1: "Funeral Costs in Indiana (2026)", description: "Indiana funeral costs and rules, with the region's medians and legal notes.", status: "live" },
