...
export const seoCatalog: SeoEntry[] = [
  ...
  { slug: "funeral-program", section: "templates", cluster: "program", h1: "Funeral Program Templates", description: "Free funeral program templates in every format — bifold, trifold, Word, and print-ready PDF — with room for their photo and story.", status: "queued" },
  { slug: "funeral-program-maker", section: "tools", cluster: "program", h1: "Free Funeral Program Maker", description: "Make a funeral program in minutes. Fill in the service details once, see it laid out beautifully, and download it ready to print.", status: "queued" },
  { slug: "funeral-program/word", section: "templates", cluster: "program", h1: "Funeral Program Template for Word", description: "An editable funeral program template for Microsoft Word, with fold guides that survive the download.", status: "queued" },
  { slug: "funeral-program/pdf", section: "templates", cluster: "program", h1: "Free PDF Funeral Program Template", description: "A print-ready PDF funeral program template with bleed and fold marks, for home printers and print shops alike.", status: "queued" },
  { slug: "funeral-program/bifold", section: "templates", cluster: "program", h1: "Bifold Funeral Program Template", description: "The classic single-fold program, panel by panel — what goes on the cover, inside, and back.", status: "queued" },
  { slug: "funeral-program/trifold", section: "templates", cluster: "program", h1: "Trifold Funeral Program Template", description: "Six panels for a longer service — order of service, obituary, hymns, and thanks, each in its place.", status: "queued" },
  { slug: "funeral-program/one-page", section: "templates", cluster: "program", h1: "One Page Funeral Program Template", description: "A simple single sheet for graveside and small services, with a large-print version included.", status: "queued" },
  { slug: "funeral-program/order-of-service", section: "templates", cluster: "program", h1: "Order of Service Template", description: "The running order of a funeral or memorial service — readings, music, and words, in sequence.", status: "queued" },
  { slug: "funeral-program/celebration-of-life", section: "templates", cluster: "program", h1: "Celebration of Life Program Template", description: "A brighter, story-first program for a celebration of life gathering.", status: "queued" },
  { slug: "funeral-program/catholic", section: "templates", cluster: "program", h1: "Catholic Funeral Mass Program Template", description: "A funeral Mass program with the full liturgical order, from the Introductory Rites to the Final Commendation.", status: "queued" },
  { slug: "funeral-program/baptist", section: "templates", cluster: "program", h1: "Baptist Funeral Program Template", description: "A homegoing service program with places for congregational songs, scripture, and the choir.", status: "queued" },
  { slug: "funeral-program/methodist", section: "templates", cluster: "program", h1: "Methodist Funeral Program Template", description: "A Service of Death and Resurrection program following the United Methodist Book of Worship.", status: "queued" },
  { slug: "funeral-program/lds", section: "templates", cluster: "program", h1: "LDS Funeral Program Template", description: "A ward chapel funeral program with the customary order of speakers and musical numbers.", status: "queued" },
  { slug: "funeral-program/jewish", section: "templates", cluster: "program", h1: "Jewish Funeral Program Template", description: "A levaya program kept simple, as the tradition asks — El Malei Rachamim, Kaddish, and the walk to the grave.", status: "queued" },
  { slug: "funeral-program/military", section: "templates", cluster: "program", h1: "Military Funeral Program Template", description: "A program that holds the honors — the flag, taps, and the words said when it is presented.", status: "queued" },
