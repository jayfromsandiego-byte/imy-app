export const content = {
  "slug": "funeral-costs/indiana",
  "intro": "No official statewide median funeral cost exists for Indiana. The closest honest number is regional. In the NFDA's 2023 study, the East North Central census division, which includes Indiana, had a median of $8,280 for a funeral with viewing and burial and $6,120 for a funeral with viewing and cremation.",
  "sections": [
    {
      "heading": "What a funeral costs in Indiana",
      "body": [
        ...
        "NFDA publishes medians by census division, not by state. Indiana sits in the East North Central division, where the 2023 median was $8,280 for a funeral with viewing and burial and $6,120 for a funeral with viewing and cremation. Any page quoting a precise Indiana statewide average is estimating; no credible body publishes one.",
        "Prices vary widely between funeral homes in the same county, so the itemized national medians below are most useful as a benchmark while you read a price list."
      ],
      "list": {
    ...
    {
      "heading": "Indiana's own rules",
      "body": [
        "Indiana has no mandatory embalming law. If a funeral home presents embalming as required, it is the home's policy, not the state's.",
        "Burial in Indiana generally must take place in an established cemetery within a reasonable time; a family cemetery on private land may be possible with local permits, proper documentation, and a burial permit from the local health officer.",
        "No law requires a casket for burial or cremation, and a funeral home must accept a casket bought from any source without a handling fee.",
        "Alkaline hydrolysis (water cremation) is not currently permitted under Indiana law."
      ]
    },
    {
      "heading": "Your rights under the Funeral Rule",
      "body": [
        "The FTC's Funeral Rule applies in Indiana as it does everywhere in the country. A funeral home must give you a written, itemized General Price List that is yours to keep, and must give prices over the phone without asking who you are. You can decline packages and buy only what you want, supply a casket or urn from anywhere without a handling fee, and choose cremation with no casket at all. Embalming is not required by federal law, and the price list must say so next to the embalming price."
      ]
    },
    {
  ...
  "faq": [
    {
      "q": "Does Indiana require embalming",
      "a": "No. Indiana has no mandatory embalming law, and under the federal Funeral Rule a funeral home cannot charge for embalming without your permission."
    },
    {
      "q": "Can we bury someone on family land in Indiana",
      "a": "Possibly. Indiana generally expects burial in an established cemetery, but a family cemetery may be created with local permits and proper documentation, plus a burial permit from the local health officer."
    },
    {
      "q": "Is water cremation legal in Indiana",
      "a": "No. Alkaline hydrolysis is not currently permitted under Indiana law. Flame cremation and burial remain the available paths."
    }
  ],
  ...
  "sources": [
    ...
    {
      "label": "Nolo, Burial and Cremation Laws in Indiana",
      "url": "https://www.nolo.com/legal-encyclopedia/burial-cremation-laws-indiana.html"
    }
  ]
} as const;
