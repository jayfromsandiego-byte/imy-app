...
ok("dashboard explains stored photos beyond twelve", media.includes("Free shows the first 12") && media.includes("wait safely for Plus"));
...
ok("visitor video URL is host restricted", memoryApi.includes("keptVideoUrl") && memoryApi.includes(".public.blob.vercel-storage.com") && memoryApi.includes("video_url: videoUrl"));
...
ok("failed films lead to authenticated retry", renderer.includes("Open the family study") && actions.includes("retryPaidFilm") && editPage.includes("Try the weave again"));
